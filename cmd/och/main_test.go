...
func TestBindAssemblyFlagsMatchesBuildConfig(t *testing.T) {
	...
	for _, field := range []struct {
		...
		{"Provider.ReasoningEffort", parsedConfig.Provider.ReasoningEffort, inProcess.Provider.ReasoningEffort},
		...
		{"Context.SummaryReasoningEffort", parsedConfig.Context.SummaryReasoningEffort, inProcess.Context.SummaryReasoningEffort},

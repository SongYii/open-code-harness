...
9. **MCP client adapter** — not designed yet; an [architecture gate](research/architecture-gates/2026-08-30-mcp-client-adapter.md) has surveyed the MCP specification, the official Go SDK, and six reference agents' MCP-client placement and approval routing ahead of a design.

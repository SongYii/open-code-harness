...
| Accepted | Plan | [Exec sandboxing and resource quotas implementation plan](superpowers/plans/2026-08-30-exec-sandboxing-resource-quotas.md) | Frozen six-task sequence, not yet executed: structured enforcement reporting, Linux bwrap and cgroup v2 quota, macOS Seatbelt and RLIMIT_AS, the fail-closed composition gate, and contract publication; no Chinese reading copy, matching the most recent prior plan's precedent |

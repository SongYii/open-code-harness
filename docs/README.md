...
| Complete | Research evidence | [Context Engine architecture gate](research/architecture-gates/2026-09-01-context-engine.md) | Focused re-read of the six pinned comparison projects plus the current Application, Domain, Store, Provider, and Runtime seams; chooses synchronous two-pass preparation, durable compaction brackets, rolling summary plus deterministic reset, exact request audit, and bounded checkpoint projection as inputs to the proposed design |
| Complete | Reading copy | [Context Engine 架构门](research/architecture-gates/2026-09-01-context-engine.zh-CN.md) | 与 Context Engine 专项架构门完整同步的中文证据记录；英文源为规范权威 |

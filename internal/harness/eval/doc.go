...
// (design §6). It is not yet a runner — there is no EvalSet, Attempt store,
// executor, or CLI here. Those build on top of the identities this package
// defines and land as separate, independently reviewable pieces.
//

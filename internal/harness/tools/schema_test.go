...
func TestValidateArgsDefaultWorkspaceSpecs(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "edit omitted replace all", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new"}`},
		{name: "edit replace all true", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","replace_all":true}`},
		{name: "edit replace all false", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","replace_all":false}`},
		{name: "edit replace all non boolean", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","replace_all":"true"}`, wantErr: true},
		{name: "edit empty old string", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"","new_string":"new"}`, wantErr: true},
		{name: "edit empty new string", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":""}`},
		{name: "edit old string too long", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"` + strings.Repeat("a", MaxWriteContentBytes+1) + `","new_string":"new"}`, wantErr: true},
		{name: "edit old string at bound", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"` + strings.Repeat("a", MaxWriteContentBytes) + `","new_string":"new"}`},
		{name: "edit new string too long", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"` + strings.Repeat("a", MaxWriteContentBytes+1) + `"}`, wantErr: true},
		{name: "edit new string at bound", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"` + strings.Repeat("a", MaxWriteContentBytes) + `"}`},
		{name: "edit missing old string", tool: NameEditFile, raw: `{"path":"a.txt","new_string":"new"}`, wantErr: true},
		{name: "edit missing new string", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old"}`, wantErr: true},
		{name: "edit unknown field", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","version":"secret"}`, wantErr: true},
		{name: "edit rejects file version", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","file_version":"secret"}`, wantErr: true},
		{name: "edit rejects mutation guard", tool: NameEditFile, raw: `{"path":"a.txt","old_string":"old","new_string":"new","mutation_guard":{"kind":"replace_if_version"}}`, wantErr: true},

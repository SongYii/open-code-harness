...
func testSessionHeadCatalog(t *testing.T, factory Factory) {
	...
	invalidCursors := []string{
		...
		base64.RawURLEncoding.EncodeToString([]byte(`{"v":1,"v":1,"p":1,"s":"session-catalog-idle"}`)),
		base64.RawURLEncoding.EncodeToString([]byte(`{"v":1,"p":1,"p":1,"s":"session-catalog-idle"}`)),
		base64.RawURLEncoding.EncodeToString([]byte(`{"v":1,"p":1,"s":"session-catalog-idle","s":"session-catalog-idle"}`)),
